...
class uwbDataset(Dataset):
    ...
    def __init__(self, data_dir, data_list,num_classes, norm=True,
                 abs=True,img_size=(256, 256)):
        """dataset for vowel, word, sentences classification
        :param data_dir: dataset root
        :param data_list: file list of dataset
        :param num_classes: class number
    ...
    def __getitem__(self, index):
        ...
        label_mapping = {1:0, 3:1, 5:2, 6:3, 7:4, 8:5, 11:6, 12:7, 13:8, 14:9, 16:10, 20:11}
        label = label_mapping[int(data_file_name.split('_')[2])]

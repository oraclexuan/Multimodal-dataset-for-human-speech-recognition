...
if __name__ == "__main__":
    ...
    parser.add_argument('--data_dir', default=r'D:\data\uwb2_train_12people')
    parser.add_argument('--save_dir', default=r'F:\Scientific_data\radar_data\word\UWB2\result\Python')
